      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-zinc-50 font-sans px-2">
          ...
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text className="text-zinc-900 ml-20 font-semibold">La 26.10 ja su 27.10.2024 klo 13-15</Text>
...
export function renderSignUpTemplate({
  ...
  return render(<SignUpTemplate email={email} subject={subject} firstname={firstname} lastname={lastname} message={message} telephone={telephone} />);
}
